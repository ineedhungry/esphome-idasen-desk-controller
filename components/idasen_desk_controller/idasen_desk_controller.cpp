  ...
  switch (event) {
    ...
    case ESP_GATTC_SEARCH_CMPL_EVT: {
      ...
      if (chr_output == nullptr) {
        this->status_set_warning();
        char output_service_uuid_buf[espbt::UUID_STR_LEN];
        char output_char_uuid_buf[espbt::UUID_STR_LEN];
      ...
      if (chr_input == nullptr) {
        this->status_set_warning();
        char input_service_uuid_buf[espbt::UUID_STR_LEN];
        char input_char_uuid_buf[espbt::UUID_STR_LEN];
        ESP_LOGW(TAG, "No characteristic found at service %s char %s",
      ...
      if (chr_control == nullptr) {
        this->status_set_warning();
        char control_service_uuid_buf[espbt::UUID_STR_LEN];
        char control_char_uuid_buf[espbt::UUID_STR_LEN];
        ESP_LOGW(TAG, "No characteristic found at service %s char %s",
