...
}).extend(cv.COMPONENT_SCHEMA).extend(ble_client.BLE_CLIENT_SCHEMA).extend(cover.Cover_COVER_SCHEMA)
...
async def to_code(config):
    ...
    cg.add(var.set_only_up_down_command(config[CONF_ONLY_UP_DOWN_COMMAND]))
